/* Quality Tools for BlueJ project.
 * See: https://metrocs.github.io/QualityToolsForBlueJ
 */
 ...
 * <a href=
 * "https://metrocs.github.io/QualityToolsForBlueJ">Quality Tools for BlueJ</a>
 * project.
 * @author <a href="https://github.com/MetroCS">MetroCS</a>
 * @author CS3250 Fall 2019 Students
 * @version 0.1.0
 */
public class QualityToolsExtension
                                  extends Extension
                                  implements PackageListener {
    private final String PROJECT_NAME = "Quality Tools";
    private final String PROJECT_DESCRIPTION = "BlueJ extension that "
        + "integrates quality assessment tools";
    private final String PROJECT_URL =
        "https://metrocs.github.io/QualityToolsForBlueJ";
     ...
     */
    @Override
    public void packageOpened(final PackageEvent ev) {
    }
     ...
     */
    @Override
    public void packageClosing(final PackageEvent ev) {
    }
 ...
 *
 * @author <a href=
 * "https://www.bluej.org/extensions/writingextensions.html">BlueJ.org</a>
...
class Preferences implements PreferenceGenerator {
         ...
         */
        public Preferences(final BlueJ bluej) {
            this.bluej = bluej;
            myPanel = new JPanel();
